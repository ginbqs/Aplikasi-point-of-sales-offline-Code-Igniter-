...
<div class="container-fluid">
    <div class="card card-primary">
        ...
        <div class="card-body">
            <div class="mb-5">
            <button type="button" class="btn btn-success" onclick="addUnits()"><i class="fa fa-plus"></i> Tambah</button>
...
$(document).ready(function() {
    var dataTable = $('#tabel_serverside').DataTable( {
        ...
        "scrollX": true,
        "ajax":{
            url :"<?php echo base_url("admin/master_data/units/json"); ?>", // json datasource
...
function addUnits()
{
    ...
    $("#modal_title").text('Tambah Satuan')
...
function editUnits(id)
{
    ...
    $('#formData')[0].reset(); // reset form on modals
    $('#modal_form').modal('show'); // show bootstrap modal
    $("#modal_title").text('Ubah Satuan')
    // $("#modal_form_size").addClass('modal-lg')
    $("#modal_form_overlay").show()
    $.get("<?php echo base_url('admin/master_data/units/edit')?>/"+id,function(response){
...
function deleteUnits(id){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo base_url('admin/master_data/units/delete')?>/"+id,
                type: 'DELETE',
                error: function() {
...
function save()
{
    ...
    if(save_method == 'add')
    {
        url = "<?php echo site_url('admin/master_data/units/create')?>";
    }
    else
    {
        url = "<?php echo site_url('admin/master_data/units/update')?>";
    }
    var data = {
